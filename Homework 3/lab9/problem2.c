/*Nathan Burdzel
  ...
  *Lab 9
  *Problem 2
  *Dynamically allocated integer list and merging problem
  *11/15/19
  */
...
/*Checks to see if test already exists in list, return 0 if it does exist, and one if it doesn't exist*/
int checkIfRepeat(int* list, int test){
	int i;
	for(i = 1; i < *list + 1; i++)
		if(list[i] == test)
